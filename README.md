...
| | |
|---|---|
| **[GetManHTTP](https://github.com/LunatikDG/GetManHTTP)** | HTTP-client for the 1C platform — build request collections, nest them by folder, auto-save on a schedule. ⭐ 9 · 15+ community issues · GPL-3.0 |
